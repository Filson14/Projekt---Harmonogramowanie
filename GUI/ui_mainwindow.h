...
#include "../Harmonogramowanie/DataModificationWidgets/datawidget.h"
#include "../Harmonogramowanie/GUI/blockplot.h"
#include "../Harmonogramowanie/GUI/settingswidget.h"
#include "../Harmonogramowanie/GUI/statisticswidget.h"
